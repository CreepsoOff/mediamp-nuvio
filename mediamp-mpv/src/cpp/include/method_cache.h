...
UTIL_EXTERN jmethodID jni_mediamp_method_EventListener_onFileLoaded;
UTIL_EXTERN jmethodID jni_mediamp_method_EventListener_onVideoReconfig;
UTIL_EXTERN jmethodID jni_mediamp_method_EventListener_onEndFile;
UTIL_EXTERN jmethodID jni_mediamp_method_EventListener_onTracksChanged;
